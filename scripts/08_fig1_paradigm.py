...
df = pd.DataFrame(
    {
        "Sound #": np.arange(1, 26),
        "Fundamental frequency (Hz)": ([400] * 5 + [600] * 7 + [450] * 8 + [550] * 5),
        "Class": c,
    }
)
df["Class"] = df["Class"].replace({1: "deviant", 2: "neutral", 3: "standard"})


sns.scatterplot(df, x="Sound #", y="Fundamental frequency (Hz)", hue="Class", marker=">",palette=['red', 'grey', 'blue'], ax=axs[0][0])
axs[0][0].set_title("A", loc="left")

# behavioral
axs[0][1].scatter([0,.5], [400, 450], marker=">")
axs[0][1].set_xlim(-.3, 3)
axs[0][1].set_ylim(300, 700)
axs[0][1].set_ylim(300, 700)
